...
export const localconfig = {
    ...
    useLocal_CSS: false, //use local css.ts or fetch remote css file from remoteURI
    ...
    quickLinkLists: [
        ...
        {
            name: "Tunnels",
            icon: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-ethernet" viewBox="0 0 16 16">
